  ...
  <PageComponent>
    ...
    <div v-else>
      <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3">
        <SurveyListItem v-for="(survey, index) in surveys.data" :key="survey.id" :survey="survey" class="opacity-0 animate-fade-in-down" @delete="deleteSurvey(survey)" :style="{animationDelay: `${index * 0.1}s`}" />
      </div>
